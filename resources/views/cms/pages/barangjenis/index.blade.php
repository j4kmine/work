                                ...
                                <div class="container">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 text-right">
                                            <div class="mt-3">
                                                <a  href="{{ route('barangjenis.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div>
                                                                <div>
                                                                    @foreach($barangkategori as $bk)
                                                                        @if($p->id_barang_kategori == $bk->id)
                                                    ...
                                                    <td>
                                                        <a href="{{ url('barangjenis/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>
                                                        <a href="{{ route('barangjenis.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
