                                ...
                                <div class="container">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 text-right">
                                            <div class="mt-3">
                                                <a  href="{{ route('fob.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div>
                                                                <div>
                                                                    @foreach (Config::get('app.fob') as $key => $val)
                                                                         @if($key == $p->tipe_fob)   
                                                                            <strong>{{ $val }}</strong>
                                                                         @endif
                                                                    @endforeach
                                                    ...
                                                    <td> <div class="d-none d-lg-block">{{ $p->freaight }}</div></td>
                                                  
                                                    <td>
                                                        <a href="{{ url('fob/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>
                                        
                                                           
                                                        <a href="{{ route('fob.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
