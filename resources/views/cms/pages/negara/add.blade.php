                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="longitude" placeholder="Enter negara Longitude" name="longitude" value="{{ old('longitude') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="latitude" placeholder="Enter negara Latitude" name="latitude" value="{{ old('latitude') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
