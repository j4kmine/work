                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="name" placeholder="Enter User Name" name="name" value="{{ old('name') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                        <div class="form-row">
                                ...
                                <div class="form-row mt-1">
                                    <div class="form-group col-md-6 m-0">
                                        ...
                                        <input id="email" placeholder="user@email.com" name="email" value="{{ old('email') }}" class="form-control r-0 light s-12 " type="text">
                                    </div>

                                    <div class="form-group col-md-6 m-0">
                                        <label for="phone" class="col-form-label s-12"><i class="icon-phone mr-2"></i>Phone</label>
                                        <input id="phone" placeholder="05112345678" name="phone" value="{{ old('phone') }}" class="form-control r-0 light s-12 " type="text">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-9 m-0">
                                        ...
                                        <input type="text" name="address" value="{{ old('address') }}" class="form-control r-0 light s-12" id="address"
