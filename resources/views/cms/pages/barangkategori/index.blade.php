                                ...
                                <div class="container">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 text-right">
                                            <div class="mt-3">
                                                <a  href="{{ route('barangkategori.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach($barangkategori as $p)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('barangkategori/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>
                                                        <a href="{{ route('barangkategori.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
