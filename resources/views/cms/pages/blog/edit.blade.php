                            ...
                            <div class="card no-b">
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">URL YOUTUBE</label>
                                                <input id="url_youtube" placeholder="Enter Blog Url Youtube" name="url_youtube" value="{{ $blog->url_youtube }}" class="form-control r-0 light s-12 " type="text">
                                            </div>
                                        </div>
                                    </div>
