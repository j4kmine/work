                                ...
                                <div class="container">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 text-right">
                                            <br/>
                                            <a  href="{{ route('iklan.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach($iklan as $p)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('iklan/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>   
                                                        <a href="{{ route('iklan.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
