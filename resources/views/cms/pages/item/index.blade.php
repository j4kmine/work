                                ...
                                <div class="container">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 text-right">
                                            <div class="mt-3">
                                                <a  href="{{ route('item.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach($item as $p)
                                                <tr>
                                                    ...
                                                    <td> <div class="d-none d-lg-block">{{ $p->harga }}</div></td>
                                                  
                                                    <td>
                                                        <a href="{{ url('item/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>
                                        
                                                           
                                                        <a href="{{ route('item.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
