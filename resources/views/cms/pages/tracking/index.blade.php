                                    ...
                                    <div class="row ">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group input-group-sm has-right-icon focused">
                                                <input class="form-control form-control-sm light r-30" placeholder="Id Order" name="search" value="{{ app('request')->input('search') }}" type="text">
                                                <i class="icon-search"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-9 text-right">
                                            <div class="mt-3">
                                                <a  href="{{ route('tracking.create') }}" class="btn btn-success btn-sm"><i class="icon-plus mr-2"></i> Add Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div>
                                                                <div>
                                                                    <strong>{{ $p->id_order }}</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="d-none d-lg-block">{{ $p->status }}</div></td>
                                                    <td> <div class="d-none d-lg-block">{{ $p->flag }}</div></td>
                                                    <td>
                                                        <a href="{{ url('tracking/hapus',$p->id) }}"><i class="icon-trash-can"></i></a>
                                        
                                                           
                                                        <a href="{{ route('tracking.edit', $p->id)}}"><i class="icon-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
