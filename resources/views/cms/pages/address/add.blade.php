...
@section('content')
            ...
            <div class="row my-3">
                <div class="col-md-8 offset-md-2">
                    <form enctype='multipart/form-data' method="post" action="{{ route('address.store') }}">
                        <div class="card no-b">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="no_hp" placeholder="Enter no_hp" name="no_hp" value="{{ old('no_hp') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="catatan" placeholder="Enter catatan" name="catatan" value="{{ old('catatan') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="kode_pos" placeholder="Enter Kode Pos" name="kode_pos" value="{{ old('kode_pos') }}" class="form-control r-0 light s-12 " type="text" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="alamat" placeholder="Enter Alamat" name="alamat" value="{{ old('alamat') }}" class="form-control r-0 light s-12 " type="text">
                                        </div>
                                    </div>
                                </div>
